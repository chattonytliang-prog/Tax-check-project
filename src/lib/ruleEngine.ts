...
export const conditionFields: Array<{ value: string; label: string }> = [
  ...
  { value: 'monthlyCost', label: '月成本费用' },
  { value: 'monthlyProfit', label: '月利润' },
  ...
  { value: 'laborCount', label: '劳务/外包人数' },
  ...
  { value: 'relatedTransactions', label: '存在关联交易' },
