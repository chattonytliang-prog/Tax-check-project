...
function TaxDataRecordView({ slot, detail }: { slot: TaxDataSlot; detail: TaxDataDetail }) {
  ...
  const configurations: Record<string, Array<[string, string[]]>> = {
    ...
    ledger: [['日期', ['entry_date', 'entryDate']], ['凭证号', ['voucher_no', 'voucherNo']], ['科目编码', ['account_code', 'accountCode']], ['上级科目', ['parent_account_name', 'parentAccountName']], ['辅助核算对象', ['auxiliary_name', 'auxiliaryName', 'account_name', 'accountName']], ['源文件科目名称', ['account_name', 'accountName']], ['摘要', ['summary']], ['借方金额', ['debit_amount', 'debitAmount']], ['贷方金额', ['credit_amount', 'creditAmount']], ['余额', ['balance_amount', 'balanceAmount']]],
