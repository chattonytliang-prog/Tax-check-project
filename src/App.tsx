...
type ConditionCandidateRuleConfig = {
  code: string
  name: string
  taxType: string
  level: RiskLevel
...
function conditionCandidateRule(config: ConditionCandidateRuleConfig): RiskRule {
  return {
    ...config,
...
const advancedCandidateRules: RiskRule[] = [
  conditionCandidateRule({
    code: 'ON-056',
    name: '销项税额显著高于进项税额',
    taxType: '增值税',
    level: '中',
